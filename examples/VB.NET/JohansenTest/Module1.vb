Module Module1
  ...
  Sub Main()
    ...
    Dim alpha As Double
    Dim retStat As Double
    Dim retCV As Double
    Dim wMaxOrder As UIntPtr
    Dim nPolyOrder As Short
    Dim nNoRelations As UInt16
    Dim traceTest As Boolean
    ...
    If nRet >= NumXLAPI.NDK_RETCODE.NDK_SUCCESS Then
      ...
      nRet = NumXLAPI.SFSDK.JohansenTest(data, wMaxOrder, nPolyOrder, traceTest, nNoRelations, alpha, retStat, retCV)
